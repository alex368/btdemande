 ...
 */
final class Version20260216091534 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event_customer (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, theme VARCHAR(255) NOT NULL, url VARCHAR(255) DEFAULT NULL, description LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE partnership (id INT AUTO_INCREMENT NOT NULL, funding_mechanism_id INT DEFAULT NULL, lastname VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, salutation VARCHAR(255) NOT NULL, linkedin VARCHAR(255) NOT NULL, occupation VARCHAR(255) NOT NULL, email LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', mobile_phone LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_8619D6AEDC38C20C (funding_mechanism_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, funding_mechanism_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, product_description LONGTEXT NOT NULL, type_product VARCHAR(255) NOT NULL, INDEX IDX_D34A04ADDC38C20C (funding_mechanism_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE roadmap (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, campany_id INT DEFAULT NULL, date DATE NOT NULL, INDEX IDX_63C3EEF34584665A (product_id), INDEX IDX_63C3EEF35F59C144 (campany_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
