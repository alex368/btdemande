 ...
 */
final class Version20251128075128 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE service_product ADD CONSTRAINT FK_1CCE5631DB805178 FOREIGN KEY (quote_id) REFERENCES quote (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
