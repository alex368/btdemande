 ...
 */
final class Version20251128105000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE quote ADD CONSTRAINT FK_6B71CBF4818A0615 FOREIGN KEY (quote_items_id) REFERENCES quote_item (id)');
