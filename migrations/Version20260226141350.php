...
final class Version20260226141350 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE funding_request ADD comment LONGTEXT DEFAULT NULL, ADD decision VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE funding_request DROP comment, DROP decision');
    }
}
